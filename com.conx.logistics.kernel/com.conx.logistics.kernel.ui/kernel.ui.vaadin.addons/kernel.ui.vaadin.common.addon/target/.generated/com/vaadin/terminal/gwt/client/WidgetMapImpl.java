...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.TextArea" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VTextArea.class); return com.vaadin.terminal.gwt.client.ui.VTextArea.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VTextArea.class) {instmap.put(com.vaadin.terminal.gwt.client.ui.VTextArea.class, new WidgetInstantiator() {
